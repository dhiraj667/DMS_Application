        ...
        <div className="flex">
            <div className="mt-8 ml-14">
              ...
              <p className="text-sm font-bold text-gray-400 mt-4">
                A DocTypeField is a something that we can add in departments
              </p>
            </div>
            <button className=" flex items-center py-2 mt-6 ml-[20rem] uppercase font-bold rounded-md w-72 h-12 bg-blue-600 text-white focus:bg-blue-700 hover:bg-purple-700">
              <svg
                aria-hidden="true"
                fill="none"
                viewBox="0 0 24 24"
              ...
              <div class="py-3 sm:px-6 lg:px-8 m-5 bg-white drop-shadow-2xl rounded-2xl overflow-auto mt-10">
              <div class="flex items-center">
                <span className="relative left-6">
                  <i class="fa fa-search"></i>
                </span>
                <input
                  class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-[64rem] pl-10 py-2 px-4 font-bold leading-tight focus:outline-none  text-gray-500"
                  id="inline-searcg"
                  type="text"
                  placeholder="Search by DocTypeField name....."
                />
              </div>
              
              <div
                className={`py-3 px-4 mt-5 flex justify-around bg-blue-200 rounded-md ml-3 mr-3 shadow-lg shadow-blue-100/50`}
              >
                <div className={``}>
                  <span
