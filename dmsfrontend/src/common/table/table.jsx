...
const Table = (props) => {
  const { items, columns, onHandleDelete, onHandleUpdate } = props;
  return (
    <>
      {" "}
            ...
            <>
              {nextItem !== "_id" ? (
                <div
                  ...
                  style={
                    iteration !== 1
                      ? item.hasOwnProperty("docTypeCode") && iteration === 2
                        ? { alignItems: "left" }
                        : iteration === 3
                        ? { textAlign: "center" }
            ...
            >
              ...
              >
                <i
                  ...
                  aria-hidden="true"
                  onClick={() => onHandleUpdate(item._id)}
                ></i>
              </Tooltip>

              <Tooltip
                className="py-0.5 rounded"
                content={<span className="bg-black text-white">Delete</span>}
              >
                <i
